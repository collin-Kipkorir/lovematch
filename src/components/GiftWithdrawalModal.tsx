...
const GiftWithdrawalModal: React.FC<GiftWithdrawalModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Only use the keys in the paths
      if (withdrawalRef.key && giftRef.key) {
        // Add withdrawal request
        updates['/withdrawalRequests/' + withdrawalRef.key] = {
          userId,
        ...
        // Add withdrawal record with positive amount for better tracking
        updates['/userGifts/' + giftRef.key] = {
          toUserId: userId,
          amount: withdrawalAmount, // Store as positive for consistency
          type: 'withdrawal',
          status: 'completed',
          timestamp,
        ...
        // Update the database using update method for atomicity
      ...
      toast({
        ...
        description: "Your withdrawal request has been submitted and your gift balance has been updated.",
      });
